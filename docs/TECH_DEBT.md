...
|---|---|---|---|---|
| Physical Mac trackpad feel in Safari and Chrome: acceleration, natural-scroll direction, inertia, edge steering, native pinch, and click/drag comfort | Desktop trackpad players | Garo as tester; Codex handles tuning | Bounded speed, click-to-hover, interruption braking, optional mouse/keyboard and tap controls; system-Chrome pointer/wheel regression tests | First trackpad playtest after delivery; before public launch. Browser automation is not a physical finger test. |
