...
// Takeoff snap on the added bones only, starting and ending at rest.
const launch: AuthoredClip = { name: 'launch', duration: 1, loop: false, additive: true, source: 'authored-table', keys: mirrorKeys({
  ...
  foot_r: [[0, 0, 0, 0], [.25, -.9, 0, 0], [.6, -.6, 0, 0], [1, 0, 0, 0]], toe_r: [[0, 0, 0, 0], [.25, -.25, 0, 0], [1, 0, 0, 0]],
}) };
...
export const ACCENTS = {
  ...
  dive: compileClip(dive), sink: compileClip(sink), launch: compileClip(launch), flare: compileClip(flare),
} as const;
